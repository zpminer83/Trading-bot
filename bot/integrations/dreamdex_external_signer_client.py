...
class DreamDexExternalSiweSignerClient:
    ...
    def _describe(self) -> None:
        ...
        self.diagnostics = ExternalSignerProcessDiagnostics(True, "confirmed", True, False, "running", True, 1)
    ...
    def sign_message(self, message: str) -> str:
        ...
        try:
            ...
            self.diagnostics = ExternalSignerProcessDiagnostics(True, "confirmed", True, True, "running", True, 2)
            return signature
        finally:
            self.close()
    ...
    def close(self) -> None:
        try:
            ...
            if self.diagnostics.started:
                self.diagnostics = replace(self.diagnostics, exit_status="closed")
...
__all__ = [
    "PROTOCOL", "OPERATIONS", "RESPONSE_STATUSES", "ExternalSignerProcessDiagnostics",
